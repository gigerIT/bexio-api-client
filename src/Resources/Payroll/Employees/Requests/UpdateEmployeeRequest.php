...
class UpdateEmployeeRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(protected readonly Employee $employee)
    {
        if ($this->employee->id === null) {
            throw new \InvalidArgumentException('id is required to update an employee.');
        }
    }

    public function resolveEndpoint(): string
    {
        return "/4.0/payroll/employees/{$this->employee->id}";
    }
